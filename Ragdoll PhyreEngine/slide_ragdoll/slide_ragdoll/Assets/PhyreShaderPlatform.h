/* SIE CONFIDENTIAL
PhyreEngine(TM) Package 3.21.0.0
...
#define PHYRE_SHADER_PLATFORM_H
	...
	#pragma warning (disable:6889)  // inlined sampler state initialization has been skipped
	#pragma warning (disable:20070) // '__user_defined__' is not a valid semantic for texture sampler and has been skipped
	#pragma warning (disable:6890)  // FX syntax annotation has been skipped
#endif //! __ORBIS__
